    ...
    public static void main(String[] args) {
       ...
       // System.out.println(newarr.toString());
        ...
        for(;i<n-1;i++)
        {
            ...
            {
                duplicate_value=newarr.get(i);
                //break;
            }
        }
        total+=newarr.get(i);
        //System.out.println(total);
        long sumofSeries=(long)(n)*(n+1)/2;
        long remain_val=sumofSeries-total;

        missing_value=duplicate_value+remain_val;

//        ArrayList<Integer> ans=new   ArrayList<Integer>();
//        ans.add(duplicate_value);
//        ans.add((int)missing_value);

        System.out.println(duplicate_value+":"+missing_value);
    }
}
